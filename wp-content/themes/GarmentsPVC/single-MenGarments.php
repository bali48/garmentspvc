    ...
    <section id="breadcrumbs" class="breadcrumbs">
        ...
        <div class="container clearfix">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?= get_permalink(get_option('MenGarments')); ?>">Men</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="product-image">
                                                ...
                                                ?>
                                                <img id="zoom" src="<?php echo get_post_meta(get_the_ID(), '_menimage1', true); ?>" data-zoom-image="<?php echo get_post_meta(get_the_ID(), '_menimage1', true); ?>" alt="" class="img-responsive">
                                                <?php } ?>
                                                <div class="product-gallery" data-lightbox="gallery">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <a href="<?php echo get_post_meta(get_the_ID(), '_menimage2', true); ?>" data-lightbox="gallery-item">
                                                                <img src="<?php echo get_post_meta(get_the_ID(), '_menimage2', true); ?>"  alt="" class="img-responsive">
                                                            </a>
                                                        </div>
                                                        <?php } ?>
                                                        <?php if (get_post_meta(get_the_ID(), '_menimage3', true)){ ?>
                                                        <div class="col-md-4">
                                                            <a href="<?php echo get_post_meta(get_the_ID(), '_menimage3', true); ?>" data-lightbox="gallery-item">
                                                                <img src="<?php echo get_post_meta(get_the_ID(), '_menimage3', true); ?>"  alt="" class="img-responsive">
                                                            </a>
                                                        </div>
                                                        <?php } ?>
                                                        <?php if (get_post_meta(get_the_ID(), '_menimage4', true)){ ?>
                                                        <div class="col-md-4">
                                                            <a href="<?php echo get_post_meta(get_the_ID(), '_menimage4', true); ?>" data-lightbox="gallery-item">
                                                                <img src="<?php echo get_post_meta(get_the_ID(), '_menimage4', true); ?>"  alt="" class="img-responsive">
                                                            </a>
                                                        </div>
                                                        <?php } ?>
                                                        <?php if (get_post_meta(get_the_ID(), '_menimage5', true)){ ?>
                                                        <div class="col-md-4">
                                                            <a href="<?php echo get_post_meta(get_the_ID(), '_menimage5', true); ?>" data-lightbox="gallery-item">
                                                                <img src="<?php echo get_post_meta(get_the_ID(), '_menimage5', true); ?>"  alt="" class="img-responsive">
                                                            </a>
                                                        </div>
                                                        <?php } ?>
                                                    </div>
...
<!--                                                                <?php
                                             ...
                                             <div class="share">
                                                <div class="pull-right">
                                                    <a class="social-icon social-facebook" onClick="window.open('http://www.facebook.com/sharer.php?s=100&amp;p[title]=<?php echo get_the_title; ?>&amp;p[url]=<?php echo the_permalink(); ?>&amp;&p[images][0]=<?php echo get_post_meta(get_the_ID(), '_menimage1', true);?>', 'sharer', 'toolbar=0,status=0,width=548,height=325');" target="_parent" href="javascript: void(0)">
                                                        <div class="front">
                                                    ...
                                                    <a class="social-icon social-twitter" onClick="window.open('http://twitter.com/share?url=<?php echo the_permalink(); ?>&via=bilal_107&image-src=<?php echo get_post_meta(get_the_ID(), '_menimage1', true);?>&text=<?php echo get_the_title; ?>')" target="_parent" href="javascript: void(0)">
                                                        <div class="front">
