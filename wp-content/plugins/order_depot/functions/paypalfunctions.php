<?php
	...
	********************************************/
	...
	$API_UserName="saeed.techloyce_api1.gmail.com";
	$API_Password="3FXXRU4Y8NFJR7MX";
	$API_Signature="Ae4FocTh-3zwzrLj44QCUErL5FumAyBkt1JXP0jYuRO6AyJAJG6zvc90";
	...
	*/
...

	{
		...
		$nvpstr = $nvpstr . "&BILLINGAGREEMENTDESCRIPTION=".urlencode("Soccer Billing");
	...
	*/
...

	{
		...
		$nvpstr .= '&CURRENCYCODE=' . $currencyCodeType . '&IPADDRESS=' . $serverName. '&L_PAYMENTREQUEST_n_ITEMCATEGORY="Digital"'.'&L_PAYMENTREQUEST_n_NAME="Times News"'
		.'&L_PAYMENTREQUEST_n_DESC="Times News Paper Subscription Details"'.'&L_PAYMENTREQUEST_n_AMT='.$FinalPaymentAmt;
...

	{
		...
		$subscritionPlan	=	urlencode($_SESSION['subscritionPlan']);

		$frequency	=	urlencode($_SESSION['frequency']);
		...
		$nvpstr.="&DESC=".urlencode("Times News Paper Subscription");

		$nvpstr.="&BILLINGPERIOD=".$subscritionPlan;
		...
		$nvpstr.="&L_PAYMENTREQUEST_n_ITEMCATEGORY=Digital";
		$nvpstr.="&L_PAYMENTREQUEST_n_NAME=Times News";
		$nvpstr.="&L_PAYMENTREQUEST_n_AMT=500";
